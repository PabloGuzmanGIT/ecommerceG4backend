...
class Picture(models.Model):
    id=models.AutoField(primary_key=True)
    ruta=modelsCloudinary.CloudinaryField(folder='muebles')
    muebleId=models.ForeignKey(to=Muebles, related_name='pictures', on_delete=models.CASCADE, db_column='mueble_id')
